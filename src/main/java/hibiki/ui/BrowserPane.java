...
public class BrowserPane extends JPanel {
  ...
  private void populateTree() {
    ...
    FileItem dr8ClapItem = new FileItem(new File("builtin"), "builtin", "DR8 Clap", "Hibiki", 0);
    ...
    FileItem dr8CrashItem = new FileItem(new File("builtin"), "builtin", "DR8 Crash", "Hibiki", 0);
    dr8CrashItem.rawPath = "builtin://dr8_crash";
    builtinNode.add(new DefaultMutableTreeNode(dr8CrashItem));

    FileItem dr8RimItem = new FileItem(new File("builtin"), "builtin", "DR8 Rimshot", "Hibiki", 0);
    dr8RimItem.rawPath = "builtin://dr8_rim";
    builtinNode.add(new DefaultMutableTreeNode(dr8RimItem));

    FileItem dr8CongaItem = new FileItem(new File("builtin"), "builtin", "DR8 Conga", "Hibiki", 0);
    dr8CongaItem.rawPath = "builtin://dr8_conga";
    builtinNode.add(new DefaultMutableTreeNode(dr8CongaItem));

    FileItem vocodeyItem = new FileItem(new File("builtin"), "builtin", "Vocodey", "Hibiki", 0);
    vocodeyItem.rawPath = "builtin://vocodey";
    builtinNode.add(new DefaultMutableTreeNode(vocodeyItem));
