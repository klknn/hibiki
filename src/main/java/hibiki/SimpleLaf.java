...
public class SimpleLaf extends BasicLookAndFeel {
    ...
    /**
     * Shows an open file dialog. Uses native FileDialog when SimpleLaf is active
     * for better HiDPI compatibility on Linux.
     * 
    ...
    /**
     * Shows a save file dialog. Uses native FileDialog when SimpleLaf is active
     * for better HiDPI compatibility on Linux.
     * 
     * @param parent the parent component
     * @param title  the dialog title
