...
/**
 * Handles all mouse interactions within automation lanes:
 * - Single click to drag points or tension handles
 * - Double click to add/remove points or rename clips
 * - Right-click context menus for points and clips
 * - Clip move/resize/create within automation lanes
 *
 * Extracted from TimelineMouseHandler to improve readability.
 */
class AutomationMouseHandler {
     ...
     * Returns the lane index (0-based), or -1 if not in a lane.
     */
