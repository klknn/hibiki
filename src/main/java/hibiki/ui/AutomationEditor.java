...
/**
 * AutomationEditor — renders and edits automation curves for a single lane. Used as collapsible
 * sub-rows below tracks in the TimelineView.
 *
 * <p>FL Studio-inspired: - Click on empty area to add a control point - Drag points to move them
 * (time + value) - Right-click a point to delete it or adjust tension - Curve is rendered with
...
public class AutomationEditor extends JPanel {
  ...
  public AutomationEditor(
      int trackIndex, int laneIndex, int pluginIndex, long paramId, String paramName) {
  ...
  public void setLaneData(
      int laneIndex, int pluginIndex, long paramId, String paramName, List<AutoPoint> pts) {
    this.laneIndex = laneIndex;
    this.pluginIndex = pluginIndex;
    this.paramId = paramId;
    this.paramName = paramName;
