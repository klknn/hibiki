...
/**
 * Renders automation curves within timeline automation lanes. Extracted from TimelineRenderer to
 * reduce file size.
 */
class AutomationRenderer {

  /** Draw an automation curve inside its lane sub-row based on individual clips. */
  static void drawAutomationCurve(
      Graphics2D g2,
    ...
    if (lane.clips == null || lane.clips.isEmpty()) return;
