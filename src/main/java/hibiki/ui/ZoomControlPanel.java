...
/**
 * Reusable control panel with grid mode selector, H/V zoom sliders, and auto-scroll checkbox. Used
 * by both PianoRoll and TimelineView.
 */
class ZoomControlPanel extends JPanel {
  ...
  ZoomControlPanel(
      ...
      Consumer<Float> onHZoom,
      int hMin,
      int hMax,
      int hInitial,
      Consumer<Float> onVZoom,
      int vMin,
      int vMax,
      int vInitial,
      Consumer<Boolean> onAutoScroll,
      boolean autoScroll) {
