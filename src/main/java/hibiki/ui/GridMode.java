 ...
 * Also provides shared interval computation and music utility methods.
 */
enum GridMode {
    ...
    /**
     * Get the tick interval for this grid mode given a MIDI resolution (ticks per
     * beat).
     * Returns -1 for AUTO/SECONDS modes (use autoTickInterval instead).
     */
    ...
    /**
     * Get the auto-computed tick interval based on zoom level.
     * Finds the finest grid that maintains minimum pixel spacing.
     */
    ...
    /**
     * Get the seconds interval for this grid mode given secondsPerBeat.
     * Returns -1 for AUTO mode (use autoSecondsInterval instead).
     */
    ...
    /**
     * Get the auto-computed seconds interval based on zoom level.
     * Finds the finest grid that maintains minimum pixel spacing.
     */
