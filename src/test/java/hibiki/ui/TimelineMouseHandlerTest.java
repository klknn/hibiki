...
/**
 * Tests for TimelineMouseHandler: DragMode state transitions, clip interactions,
 * mouse cursor changes, and delegation to AutomationMouseHandler.
 */
public class TimelineMouseHandlerTest {
    ...
    public void testPress_onClip_setupsDragState() {
        ...
        MouseEvent press = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_PRESSED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, x, trackTopY, 1, false, MouseEvent.BUTTON1);
    ...
    public void testPress_nearRightEdge_setsResizeMode() {
        ...
        MouseEvent press = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_PRESSED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, rightEdgeX, trackTopY, 1, false, MouseEvent.BUTTON1);
        for (MouseListener ml : view.contentPanel.getMouseListeners()) {
            ml.mousePressed(press);
        }
    ...
    public void testRelease_resetsAllDragState() {
        ...
        MouseEvent release = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_RELEASED,
    ...
    public void testDrag_belowThreshold_doesNotStartMove() {
        ...
        MouseEvent drag = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_DRAGGED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, 102, 100, 1, false, MouseEvent.BUTTON1);
    ...
    public void testDrag_aboveThreshold_startsMove() {
        ...
        MouseEvent drag = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_DRAGGED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, 110, scaleTimeRuler + 20, 1, false, MouseEvent.BUTTON1);
        for (MouseMotionListener ml : view.contentPanel.getMouseMotionListeners()) {
            ml.mouseDragged(drag);
        }
    ...
    public void testDrag_createMode_updatesDuration() {
        ...
        int scaleTimeRuler = Theme.getInstance().scale(TimelineView.TIME_RULER_HEIGHT);
        MouseEvent drag = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_DRAGGED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK | InputEvent.SHIFT_DOWN_MASK,
                x, scaleTimeRuler + 20, 1, false, MouseEvent.BUTTON1);
        for (MouseMotionListener ml : view.contentPanel.getMouseMotionListeners()) {
            ml.mouseDragged(drag);
        }
    ...
    public void testDrag_resizeMode_updatesDuration() {
        ...
        int scaleTimeRuler = Theme.getInstance().scale(TimelineView.TIME_RULER_HEIGHT);
        MouseEvent drag = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_DRAGGED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, x, scaleTimeRuler + 20, 1, false, MouseEvent.BUTTON1);
        for (MouseMotionListener ml : view.contentPanel.getMouseMotionListeners()) {
            ml.mouseDragged(drag);
        }
    ...
    public void testMouseMoved_nearRightEdge_setsResizeCursor() {
        ...
        MouseEvent move = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_MOVED,
                System.currentTimeMillis(), 0, rightEdgeX, scaleTimeRuler + 10, 0, false);
        for (MouseMotionListener ml : view.contentPanel.getMouseMotionListeners()) {
            ml.mouseMoved(move);
        }
    ...
    public void testMouseMoved_awayFromEdge_defaultCursor() {
        ...
        MouseEvent move = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_MOVED,
                System.currentTimeMillis(), 0, x, scaleTimeRuler + 10, 0, false);
        for (MouseMotionListener ml : view.contentPanel.getMouseMotionListeners()) {
            ml.mouseMoved(move);
        }
    ...
    public void testPress_inAutomationLane_delegatesToAutoHandler() {
        ...
        MouseEvent press = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_PRESSED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, 200, y, 1, false, MouseEvent.BUTTON1);
        for (MouseListener ml : view.contentPanel.getMouseListeners()) {
            ml.mousePressed(press);
        }
    ...
    public void testPress_inTimeRuler_updatesPlayhead() {
        ...
        MouseEvent press = new MouseEvent(view.contentPanel, MouseEvent.MOUSE_PRESSED,
                System.currentTimeMillis(), InputEvent.BUTTON1_DOWN_MASK, x, 5, 1, false, MouseEvent.BUTTON1);
        for (MouseListener ml : view.contentPanel.getMouseListeners()) {
            ml.mousePressed(press);
        }
